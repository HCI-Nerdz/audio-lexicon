...
import { curatedSampleEntries } from "./fetch-curated-music.mjs";
...
const samples = [
  ...
  ...curatedSampleEntries(),
  {
    ...
    path: "",
    attribution:
      "Commercial hits (Skrillex, M.I.A. Paper Planes, etc.) cannot ship here — use CC0/CC items with a clear license field.",
    downloadUrl: "https://archive.org/search?query=licenseurl%3A(*zero*%20OR%20*publicdomain*)%20AND%20mediatype%3Aaudio",
    curated: false,
  },
];
